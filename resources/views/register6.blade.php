    ...
    <div class="form-container">
        <div class="title d-flex flex-column align-item-center justify-content-center my-2">
            ...
            <div class="text-title">
                <h1 class="fs-5">Others / Autres</h1>
                <span class="fw-bold">Fill this form to register <i class="fw-light">Veuillez remplir ce formulaire pour vous inscrire</i></span>
            </div>
        </div>
        <form action="{{ url('/register6') }}" method="post">
            @csrf
            <div class="form-group mb-3">
                <label for="other_background">Other Academic Background / Autres Background Academic</label>
                <textarea name="other_background" id="other_background" class="form-control" cols="30" rows="10"></textarea>
            </div>
